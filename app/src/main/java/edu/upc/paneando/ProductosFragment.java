...
//    private String mParam2;
    ...
    public ProductosFragment() {
        ...
        //objProductoDAO = new ProductoDAO(getActivity());
    }
...
//        customAdapter = new CustomAdapter(getActivity(), productos);
//        rcvProductos.setAdapter(customAdapter);
//        rcvProductos.setLayoutManager(new LinearLayoutManager(getActivity()));
